...
def isAttendanceOpen():
    start_time = datetime.strptime("19:53:00", "%H:%M:%S").time()  # e.g., 9:00 AM
    end_time = datetime.strptime("19:54:00", "%H:%M:%S").time()    # e.g., 10:00 AM
...
def isBeforeStartTime():
    start_time = datetime.strptime("19:53:00", "%H:%M:%S").time()
    current_time = datetime.now().time()
